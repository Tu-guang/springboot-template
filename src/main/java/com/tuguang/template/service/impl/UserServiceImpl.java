...
import com.tuguang.template.mapper.UserMapper;
...
import com.tuguang.template.model.vo.UserRoleEnum;
import com.tuguang.template.model.vo.UserVO;
import com.tuguang.template.service.UserService;
import com.tuguang.template.utils.SqlUtils;
import com.tuguang.template.utils.TokenUtil;
...
import static com.tuguang.template.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            //默认头像
            user.setAvatar("https://lyzz.top/file/37007");
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        String id = TokenUtil.verify(token);
        // 先判断是否已登录
